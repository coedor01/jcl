            ...
            <div class="u-event" @click="selectedEvent = event">
                <template v-if="event.event === 'BUFF'">
                    <div class="u-event__buff">
                        ...
                        <div class="u-detail">
                            ...
                            <img class="u-eat-icon" src="@/assets/img/pve/eat.svg" alt="" />
                ...
                <template v-else-if="event.event === '重伤'">
                    <div class="u-event__death">
                        ...
                        <div class="u-detail">
                            <jcl-entity :entity="event.playerId"></jcl-entity>
                            <img class="u-grave-icon" src="@/assets/img/pve/grave.svg" alt="" />
        ...
        <template v-else>
            ...
            <template v-if="selectedEvent.event == '重伤'">
                <div class="u-damage-detail">
                    <el-table class="u-table" :data="selectedEvent.detail.detail" :border="false">
...
import { getResourceName, getResourceIcon, getEntityName } from "@/utils/common";
